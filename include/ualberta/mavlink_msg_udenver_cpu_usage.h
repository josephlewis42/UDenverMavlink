...
{
 float cpu_usage; ///< 
 uint16_t mem_total_kb; ///< 
 uint16_t mem_free_kb; ///< 
} mavlink_udenver_cpu_usage_t;

#define MAVLINK_MSG_ID_UDENVER_CPU_USAGE_LEN 8
#define MAVLINK_MSG_ID_230_LEN 8

#define MAVLINK_MSG_ID_UDENVER_CPU_USAGE_CRC 90
...
#define MAVLINK_MESSAGE_INFO_UDENVER_CPU_USAGE { \
	...
	{  { "cpu_usage", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_udenver_cpu_usage_t, cpu_usage) }, \
         { "mem_total_kb", NULL, MAVLINK_TYPE_UINT16_T, 0, 4, offsetof(mavlink_udenver_cpu_usage_t, mem_total_kb) }, \
         { "mem_free_kb", NULL, MAVLINK_TYPE_UINT16_T, 0, 6, offsetof(mavlink_udenver_cpu_usage_t, mem_free_kb) }, \
         } \
}
...
static inline uint16_t mavlink_msg_udenver_cpu_usage_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       float cpu_usage, uint16_t mem_total_kb, uint16_t mem_free_kb)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_UDENVER_CPU_USAGE_LEN];
	_mav_put_float(buf, 0, cpu_usage);
	_mav_put_uint16_t(buf, 4, mem_total_kb);
	_mav_put_uint16_t(buf, 6, mem_free_kb);
	...
	packet.mem_total_kb = mem_total_kb;
	packet.mem_free_kb = mem_free_kb;
...
{
	return mavlink_msg_udenver_cpu_usage_pack(system_id, component_id, msg, udenver_cpu_usage->cpu_usage, udenver_cpu_usage->mem_total_kb, udenver_cpu_usage->mem_free_kb);
}
...
{
	return mavlink_msg_udenver_cpu_usage_pack_chan(system_id, component_id, chan, msg, udenver_cpu_usage->cpu_usage, udenver_cpu_usage->mem_total_kb, udenver_cpu_usage->mem_free_kb);
}
...
static inline void mavlink_msg_udenver_cpu_usage_send(mavlink_channel_t chan, float cpu_usage, uint16_t mem_total_kb, uint16_t mem_free_kb)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_UDENVER_CPU_USAGE_LEN];
	_mav_put_float(buf, 0, cpu_usage);
 ...
 */
static inline void mavlink_msg_udenver_cpu_usage_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float cpu_usage, uint16_t mem_total_kb, uint16_t mem_free_kb)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field mem_total_kb from udenver_cpu_usage message
 *
 * @return 
 */
static inline uint16_t mavlink_msg_udenver_cpu_usage_get_mem_total_kb(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint16_t(msg,  4);
}

/**
 * @brief Get field mem_free_kb from udenver_cpu_usage message
 *
 * @return 
 */
static inline uint16_t mavlink_msg_udenver_cpu_usage_get_mem_free_kb(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_udenver_cpu_usage_decode(const mavlink_message_t* msg, mavlink_udenver_cpu_usage_t* udenver_cpu_usage)
{
	...
	udenver_cpu_usage->mem_total_kb = mavlink_msg_udenver_cpu_usage_get_mem_total_kb(msg);
	udenver_cpu_usage->mem_free_kb = mavlink_msg_udenver_cpu_usage_get_mem_free_kb(msg);
#else
